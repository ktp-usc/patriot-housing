    ...
    <header className="border-b border-slate-200 bg-white">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-2 md:px-8">
        <span className="text-base font-bold text-slate-900">
          <Link href="/" className="inline-flex items-center gap-2 px-2 hover:underline hover:decoration-red-600 hover:underline-offset-6 decoration-3"><Image src={Logo} alt="Patriot Housing Logo" className="size-6 rounded-full" />Patriot Housing</Link>
        </span>
